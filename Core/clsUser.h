...
private:
    ...
    static clsUser _ConvertLinetoUserObject(string Line, string Seperator = "#//#")
    {
        ...
        vUserData[5] = clsUtil::DecryptText(vUserData[5], 5);
    ...
    static  vector <clsUser> _LoadUsersDataFromFile()
    {
        ...
        fstream MyFile;
        MyFile.open("Databases/Users.txt", ios::in);//read Mode
    ...
    static void _SaveUsersDataToFile(vector <clsUser> vUsers)
    {
        ...
        fstream MyFile;
        MyFile.open("Databases/Users.txt", ios::out);
        ...
        if (MyFile.is_open())
        {
            ...
            {
                if (!U.IsEmpty() && !U._MarkedForDelete)
                {
    ...
    {
        fstream MyFile;
        MyFile.open("Databases/Users.txt", ios::out | ios::app);
...
public:
    ...
    enum enPermissions {
        eAll = 511, pListClients = 1, pAddNewClient = 2, pDeleteClient = 4,
    ...
    void RegisterLogIn()
    {
        ...
        fstream MyFile;
        MyFile.open("Databases/LoginRegister.txt", ios::out | ios::app);
    ...
    static  vector <stLoginRegisterRecord> GetLoginRegisterList()
    {
        ...
        fstream MyFile;
        MyFile.open("Databases/LoginRegister.txt", ios::in);//read Mode
